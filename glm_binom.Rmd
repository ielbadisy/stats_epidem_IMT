...
`grade` : état pathologique de la tum;eur déterminé par biopsie (0=moyen, 1=grave) 
...
```{r}
cancerprostate <- read.csv("~/Desktop/STAT2/STAT_Teaching/datasets/cancerprostate.txt", sep=";") # chemin à changer !!!
...
plot(x, y, type = "l", xlab ="log.acid", ylab ="p(log.acid)")
abline(h = 0.5, lty = 2)
xlim <- -beta[1]/beta[2]
abline(v = xlim, lty = 2)
```
